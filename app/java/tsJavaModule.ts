...
// tsJavaModulePath:
//   ./app/java/tsJavaModule.ts
// classpath:
//   app/bin/electron-node-java-0.0.1-jar-with-dependencies.jar
// classes:
//   <none>
// packages:
//   com.todo.**
...
function beforeJvm(): BluePromise<void> {
  var moduleJars: string[] = ['app/bin/electron-node-java-0.0.1-jar-with-dependencies.jar'];
...
export module Java {
  ...
  export function importClass(className: 'Item'): Java.com.todo.Item.Static;
  export function importClass(className: 'Repository'): Java.com.todo.Repository.Static;
  ...
  export function importClass(className: 'com.todo.Item'): Java.com.todo.Item.Static;
  export function importClass(className: 'com.todo.Repository'): Java.com.todo.Repository.Static;
  ...
  export function asInstanceOf(obj: any, className: 'Item'): Java.com.todo.Item;
  export function asInstanceOf(obj: any, className: 'Repository'): Java.com.todo.Repository;
  ...
  export function asInstanceOf(obj: any, className: 'com.todo.Item'): Java.com.todo.Item;
  export function asInstanceOf(obj: any, className: 'com.todo.Repository'): Java.com.todo.Repository;
  ...
  export function newInstanceA(className: 'Item', arg0: string_t, cb: Callback<Java.Item>): void;
  export function newInstanceA(className: 'Repository', cb: Callback<Java.Repository>): void;
  ...
  export function newInstanceA(className: 'com.todo.Item', arg0: string_t, cb: Callback<Java.Item>): void;
  export function newInstanceA(className: 'com.todo.Repository', cb: Callback<Java.Repository>): void;
  ...
  export function newInstance(className: 'Item', arg0: string_t): Java.Item;
  export function newInstance(className: 'Repository'): Java.Repository;
  ...
  export function newInstance(className: 'com.todo.Item', arg0: string_t): Java.Item;
  export function newInstance(className: 'com.todo.Repository'): Java.Repository;
  ...
  export function newInstanceP(className: 'Item', arg0: string_t): Promise<Java.Item>;
  export function newInstanceP(className: 'Repository'): Promise<Java.Repository>;
  ...
  export function newInstanceP(className: 'com.todo.Item', arg0: string_t): Promise<Java.Item>;
  export function newInstanceP(className: 'com.todo.Repository'): Promise<Java.Repository>;
  ...
  export function newArray(className: 'Item', arg: Java.Item[]): array_t<com.todo.Item>;
  export function newArray(className: 'Repository', arg: Java.Repository[]): array_t<com.todo.Repository>;
  ...
  export function newArray(className: 'com.todo.Item', arg: Java.Item[]): array_t<com.todo.Item>;
  export function newArray(className: 'com.todo.Repository', arg: Java.Repository[]): array_t<com.todo.Repository>;
  ...
  export import Item = com.todo.Item;
  export import Repository = com.todo.Repository;
  export import Object = java.lang.Object;
  export import String = java.lang.String;

  export module com.todo {
    export interface Item extends Java.java.lang.Object {
      ...
      // public java.lang.String com.todo.Item.getName()
      ...
      // public void com.todo.Item.setName(java.lang.String)
      setNameA(arg0: string_t, cb: Callback<void>): void;
      setName(arg0: string_t): void;
      setNameP(arg0: string_t): Promise<void>;
    ...
    export module Item {
      export interface Static {
        class: Java.Object;
        new (arg0: string_t): com.todo.Item;
      }
    }
  }

  export module com.todo {
    export interface Repository extends Java.java.lang.Object {
      // public void com.todo.Repository.createTable()
      createTableA( cb: Callback<void>): void;
      createTable(): void;
      createTableP(): Promise<void>;
      // public void com.todo.Repository.deleteTable()
      deleteTableA( cb: Callback<void>): void;
      deleteTable(): void;
      deleteTableP(): Promise<void>;
      // public boolean java.lang.Object.equals(java.lang.Object)
      equalsA(arg0: object_t, cb: Callback<object_t>): void;
      equals(arg0: object_t): object_t;
      equalsP(arg0: object_t): Promise<object_t>;
      ...
      getClass(): object_t;
      getClassP(): Promise<object_t>;
      // public java.util.ArrayList<com.todo.Item> com.todo.Repository.getDataTable()
      getDataTableA( cb: Callback<object_t>): void;
      getDataTable(): object_t;
      getDataTableP(): Promise<object_t>;
      // public native int java.lang.Object.hashCode()
      hashCodeA( cb: Callback<object_t>): void;
      hashCode(): object_t;
      hashCodeP(): Promise<object_t>;
      // public void com.todo.Repository.insertItem(com.todo.Item)
      insertItemA(arg0: Java.Item, cb: Callback<void>): void;
      insertItem(arg0: Java.Item): void;
      insertItemP(arg0: Java.Item): Promise<void>;
      // public final native void java.lang.Object.notify()
      notifyA( cb: Callback<void>): void;
      notify(): void;
      notifyP(): Promise<void>;
