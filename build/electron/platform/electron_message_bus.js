...
var ElectronMessageBus = (function () {
    ...
    ElectronMessageBus = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [ElectronMessageBusSink, ElectronMessageBusSource, String])
    ], ElectronMessageBus);
...
var ElectronMessageBusSink = (function () {
    ...
    ElectronMessageBusSink.prototype.attachToZone = function (zone) {
        var _this = this;
        this._zone = zone;
        this._zone.onMicrotaskEmpty.subscribe(function () { _this._handleOnEventDone(); });
    };
